...
- [x] Extract `_save_upload()` in `main.py` used by all endpoints. Update endpoints in `main.py` to handle exceptions and return 4xx/5xx properly.
- [x] Make `progress_bar.py` wrap `core.py` operations.
